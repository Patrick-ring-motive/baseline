void async function ImportResources() {
  if (globalThis.ImportResourcesRunning) {
    return;
  }
  ...
  if (!select('link[href^="https://patrick-ring-motive.github.io/baseline/static/colors.css"]')) {
    body().appendChild(buildElement('link', {
      attr: {
        href: "https://patrick-ring-motive.github.io/baseline/static/colors.css",
        rel: "stylesheet"
      }
    }));
  }
  if (!select('link[href^="https://patrick-ring-motive.github.io/baseline/static/golang.css"]')) {
    body().appendChild(buildElement('link', {
      attr: {
        href: "https://patrick-ring-motive.github.io/baseline/static/golang.css",
        rel: "stylesheet"
      }
    }));
  }
